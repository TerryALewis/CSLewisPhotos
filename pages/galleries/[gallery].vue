<template>
  <div class="bg-gray-200 h-screen">
    ...
    <div class="py-2 border border-b-2 border-b-gray-400 flex justify-center">
      <h2 class="text-[#159243] text-5xl font-semibold">
        {{ photoCatalog.getGalleryByID(galleryDesiredInt)?.title }} Gallery
      </h2>
    </div>
        ...
        >
          ...
          >
            ...
            <div class="flex justify-end">
              <button
                @click="addToCart(samplePhoto._id)"
                class="text-xs text-[#159243]"
              >
                <nuxt-icon
                  name="MdiCartOutline"
                  class="text-[#159243] h-3 w-3 inline-block pr-1"
                />
                Add to cart
              </button>
            </div>
